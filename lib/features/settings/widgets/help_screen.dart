      ...
      child: Column(
        ...
        children: [
          ...
          _buildControlItem(
            ...
            Icons.arrow_right,
            'OpenAI settings',
            'API Key field, Base URL field, Model selector, Reasoning Effort selector (minimal/low/medium/high)',
          ),
          _buildControlItem(
            context,
            Icons.arrow_right,
            'Local OpenAI settings',
            'Endpoint URL, Model selector, API Key field, Reasoning Effort selector (sends reasoning_effort + chat_template_kwargs to llama.cpp)',
          ),
          _buildControlItem(
            context,
            Icons.arrow_right,
            'Gemini settings',
            'API Key field, Model selector, Reasoning Effort selector (maps to thinkingBudget)',
          ),
          _buildControlItem(
            context,
            Icons.psychology,
            'Reasoning Effort',
            'Off disables reasoning. For llama.cpp b9474+ this sends chat_template_kwargs.enable_thinking and reasoning_effort; for OpenAI/Gemini the provider-specific field is set.',
          ),
          const Divider(),
