...
#   scripts/release_app.sh 1.3.0            # explicit version, auto-bump build
#   scripts/release_app.sh 1.3.0 37         # explicit version + build number
#
# Outputs:
#   LuteForMobile-v<ver>.apk
#   LuteForMobilePWA-v<ver>.zip
